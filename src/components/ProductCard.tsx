  ...
  return (
    <>
      <div
        ref={animation.ref}
        className={cn(
          "group relative overflow-hidden rounded-lg transition-all duration-300 hover:shadow-lg cursor-pointer",
          animation.className
        )}
      ...
      >
        ...
        <div className="p-4 bg-card/40 backdrop-blur-sm">
          ...
          <div className="mt-2 font-medium">₹{product.price.toFixed(0)}</div>
        </div>
      </div>
